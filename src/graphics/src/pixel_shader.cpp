...
bool CPixelShader::Initialize(ID3D11Device& Device, const std::string& FileName,
  ...
  Result = Device.CreatePixelShader(pCompiledPixelShader->GetBufferPointer(),
                                    pCompiledPixelShader->GetBufferSize(),
                                    nullptr, _pPixelShader.GetAddressOf());
